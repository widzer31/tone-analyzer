...
public class ToneAnalyzerIT extends WatsonServiceTest {
  ...
  private String text = "AAAAAAAAAAAAAAAAAAAAAAAAAAAA "
      + "GGGGGGGGGGGGGGGGGGGGGGGGGGGGGGG ";
      
      

  private String[] users = { "users", "users" };
  private String[] texts = { "My TV wasn't working.",
  ...
  public void testGetChatTone() {
    ...
    Assert.assertEquals("My TV wasn't working.", utterancesTone.getUtterancesTone().get(0).getUtteranceText());
  }
}
